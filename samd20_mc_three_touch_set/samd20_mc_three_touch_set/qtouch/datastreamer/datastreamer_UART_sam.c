...
This file is part of QTouch Modular Library 7.2 application.
...
extern qtm_touch_key_config_t    qtlib_key_configs_set1[DEF_NUM_SENSORS_1];
...
void datastreamer_output(void)
{
	...
	for (count_bytes_out = 0u; count_bytes_out < DEF_NUM_CHANNELS_1; count_bytes_out++) {
